    ...
    render(){
        return(
            ...
            <div className="PBbox c">
                ...
                <div className="PBvendido-por"><strong>-Vendido por:</strong>{this.props.proddetails.data.autor_email}</div>
                <div className="PBenviado-por"><strong>-Enviado por:</strong>{this.props.proddetails.data.p_logistic_seller}</div>
