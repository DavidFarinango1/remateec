            ...
            <div className="secundary-box">
                <div className="SBbox d">
                    <div className="SBall-details">
                        <p style={{whiteSpace: 'pre-line'}} className="SBlist">{this.props.proddetails.data.p_details_general_description1}</p>
                ...
                <div className="SBbox e">
                    <div className="SBall-details">
                    <p style={{whiteSpace: 'pre-line'}} className="SBlist">{this.props.proddetails.data.p_details_general_description2}</p>
                    ...
                    {/* </ul> */}
                    {/* <h4 className="SBdetails-title">{this.props.data.p_title_general_description3}</h4>
                    <ul className="SBlist"><li>{this.props.data.p_details_general_description3}</li>
                    </ul> */}
                    </div>
                </div>
            </div>
